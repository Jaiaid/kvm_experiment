...
if __name__=="__main__":
    ...
    print("Copy Operation throughput max over all vms:")
    print(np.max(copy_throughput_array[:,0]))
    print("Copy Operation throughput min over all vms:")
    print(np.min(copy_throughput_array[:,0]))
    print("\n")
    ...
    print("Scale Operation throughput max over all vms:")
    print(np.max(scale_throughput_array[:,0]))
    print("Scale Operation throughput min over all vms:")
    print(np.min(scale_throughput_array[:,0]))
    print("\n")
    ...
    print("Triad Operation throughput max over all vms:")
    print(np.max(triad_throughput_array[:,0]))
    print("Triad Operation throughput min over all vms:")
    print(np.min(triad_throughput_array[:,0]))
    print("\n")
    ...
    print("Add Operation throughput max over all vms:")
    print(np.max(add_throughput_array[:,0]))
    print("Add Operation throughput min over all vms:")
    print(np.min(add_throughput_array[:,0]))
    print("\n")
